...
let y = class extends M {
    ...
    render() {
        const e = u.newVaadinVersionState?.versions !== void 0 && u.newVaadinVersionState.versions.length > 0,
            t = [...this.serverInfo, ...this.clientInfo];
        let o = this.getIndex("Spring") + 1;
        o === 0 && (o = t.length), S.springSecurityEnabled && (t.splice(o, 0, {
            name: "Spring Security",
            version: "true"
        }), o++), S.springJpaDataEnabled && (t.splice(o, 0, {name: "Spring Data JPA", version: "true"}), o++);
