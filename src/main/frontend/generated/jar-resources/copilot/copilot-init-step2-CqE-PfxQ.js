...
class wt {
    ...
    dragging(t, i) {
        const n = i.clientX, o = i.clientY, s = n - this.offsetX,
            a = n - this.offsetX + t.getBoundingClientRect().width, p = o - this.offsetY,
    ...
    adjust(t, i, n, o, s) {
        let a, p, m, v;
        const x = document.documentElement.getBoundingClientRect().width,
...
let w = class extends I {
    ...
    renderHotswapAgentJdkSection(e) {
        const t = r.jdkInfo?.extendedClassDefCapable,
            i = this.downloadStatusMessages?.[this.downloadStatusMessages.length - 1] === ye;
        return l`
      <div class="inner-section">
        <details class="inner" .open="${!t}">
          <summary>
...
function Te(e) {
    return ce("copilot-switch-user", {username: e}, (t) => t.data.error ? (M({
        type: _.ERROR,
    ...
    constructor() {
        super(...arguments), this.initialMouseDownPosition = null, this.dragging = !1, this.items = [], this.mouseDownListener = (e) => {
            this.initialMouseDownPosition = {
                x: e.clientX,
                y: e.clientY
            }, P.draggingStarts(this, e), document.addEventListener("mousemove", this.documentDraggingMouseMoveEventListener);
            ...
            return i ? Array.from(i).some((o) => {
                ...
                if (!s)
                    return !1;
                const a = s.getBoundingClientRect(), p = n.getBoundingClientRect(), m = Math.min(a.x, p.x),
                    v = Math.min(a.y, p.y), x = Math.max(a.width, p.width), N = a.height + p.height;
...
let D = class extends I {
    constructor() {
        super(...arguments), this.panelTag = "", this.dockingItems = [
            ...
            const {width: t, height: i} = this.getBoundingClientRect(), {
                    ...
                    bottom: s,
                    right: a
                } = P.anchor(this), p = window.getComputedStyle(this.container), m = Number.parseInt(p.borderTopWidth, 10),
                v = Number.parseInt(p.borderBottomWidth, 10);
    ...
    `;
            ...
            }), this.toggling = !0, this.toggleAttribute("expanded", this.panelInfo.expanded), g.emit("panel-expanded", {
    ...
    setResizePosition(e, t, i) {
        const n = this.rectangleBeforeResizing, o = 0, s = window.innerWidth, a = 0, p = window.innerHeight,
            m = Math.max(o, Math.min(s, t)), v = Math.max(a, Math.min(p, i));
        if (e === "left")
...
g.on("undoRedo", (e) => {
    const i = {files: Ht(e), uiId: et()}, n = e.detail.undo ? "copilot-plugin-undo" : "copilot-plugin-redo",
