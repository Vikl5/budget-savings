...
function va(e, t) {
    ...
    function a(s, l) {
        var c, u, d = Ye(s)[m],
            v = new Se(l, (c = (u = n.options_) == null ? void 0 : u.enhancer) != null ? c : Ne, process.env.NODE_ENV !== "production" ? d.name_ + "." + i.toString() : "ObservableObject." + i.toString(), !1);
...
var $a = {
    ...
    }, S = /* @__PURE__ */ ii(bi, $a), _i = "computed", Da = "computed.struct", Tn = /* @__PURE__ */ Jn(_i),
    Ta = /* @__PURE__ */ Jn(Da, {
...
var Yn = "action", Xa = "action.bound", Di = "autoAction", Ya = "autoAction.bound", Ti = "<unnamed action>",
    Vn = /* @__PURE__ */ St(Yn), Za = /* @__PURE__ */ St(Xa, {
        bound: !0
    }), Rn = /* @__PURE__ */ St(Di, {
        autoAction: !0
    }), Qa = /* @__PURE__ */ St(Ya, {
...
function Zn(e, t, n) {
    ...
    var a = (r = n.name) != null ? r : process.env.NODE_ENV !== "production" ? "Reaction@" + B() : "Reaction",
        s = Oe(a, n.onError ? ts(n.onError, t) : t), l = !n.scheduler && !n.delay, c = Vi(n), u = !0, d = !1, v,
        p = n.compareStructural ? Be.structural : n.equals || Be.default, b = new ee(a, function () {
            u || l ? E() : d || (d = !0, c(E));
...
var _n = /* @__PURE__ */ hi("flow"), ls = /* @__PURE__ */ hi("flow.bound", {
    ...
    var r = t, i = r.name || "<unnamed flow>", o = function () {
        var s = this, l = arguments, c = ++ss, u = Oe(i + " - runid: " + c + " - init", r).apply(s, l), d, v = void 0,
            p = new Promise(function (b, E) {
                var x = 0;
                d = E;
...
var bs = {}, de = "add", Gt = "delete", Bi = /* @__PURE__ */ function () {
    ...
    return t.has_ = function (r) {
        ...
        Y(this.keysAtom_), oe(function () {
            var c,
                u = new Se(i, o.enhancer_, process.env.NODE_ENV !== "production" ? o.name_ + "." + Pn(r) : "ObservableMap.key", !1);
...
Extending builtins is not supported.`), e;
    ...
    var r = (n = t?.name) != null ? n : process.env.NODE_ENV !== "production" ? (P(e) ? "ObservableObject" : e.constructor.name) + "@" + B() : "ObservableObject",
        i = new jn(e, /* @__PURE__ */ new Map(), String(r), Ca(t));
    return rn(e, m, i), e;
}
...
const Ps = Symbol.for("react.portal"), $s = Symbol.for("react.fragment"), Ds = Symbol.for("react.strict_mode"),
    Ts = Symbol.for("react.profiler"), ks = Symbol.for("react.provider"), Is = Symbol.for("react.context"),
    Xi = Symbol.for("react.forward_ref"), Vs = Symbol.for("react.suspense"), Rs = Symbol.for("react.suspense_list"),
    js = Symbol.for("react.memo"), Ms = Symbol.for("react.lazy");
function Ls(e, t, n) {
...
const hn = async (e, t, n) => window.Vaadin.copilot.comm(e, t, n), ve = "copilot-", Xs = "24.7.5",
    lu = "attention-required", cu = "https://plugins.jetbrains.com/plugin/23758-vaadin",
    uu = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode";
function du(e) {
 ...
 */
const Mt = globalThis,
    nr = Mt.ShadowRoot && (Mt.ShadyCSS === void 0 || Mt.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype,
    rr = Symbol(), Tr = /* @__PURE__ */ new WeakMap();
let co = class {
    constructor(t, n, r) {
...
const {
        ...
        getOwnPropertyNames: Cl,
        getOwnPropertySymbols: Pl,
        getPrototypeOf: $l
    } = Object, pn = globalThis, Ir = pn.trustedTypes, Dl = Ir ? Ir.emptyScript : "",
    Tl = pn.reactiveElementPolyfillSupport, ft = (e, t) => e, Un = {
        toAttribute(e, t) {
            switch (t) {
                case Boolean:
                    e = e ? Dl : null;
...
let Me = class extends HTMLElement {
    ...
    static getPropertyDescriptor(t, n, r) {
        const {get: i, set: o} = Nl(this.prototype, t) ?? {
            get() {
                return this[n];
            }, set(a) {
                this[n] = a;
    ...
    _$AK(t, n) {
        ...
        if (i !== void 0 && this._$Em !== i) {
            const o = r.getPropertyOptions(i),
                a = typeof o.converter == "function" ? {fromAttribute: o.converter} : o.converter?.fromAttribute !== void 0 ? o.converter : Un;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ir = globalThis, en = ir.trustedTypes, jr = en ? en.createPolicy("lit-html", {createHTML: (e) => e}) : void 0,
    fo = "$lit$", ue = `lit$${Math.random().toFixed(9).slice(2)}$`, ho = "?" + ue, Vl = `<${ho}>`, De = document,
    yt = () => De.createComment(""), wt = (e) => e === null || typeof e != "object" && typeof e != "function",
    or = Array.isArray, Rl = (e) => or(e) || typeof e?.[Symbol.iterator] == "function", An = `[ 	
\f\r]`, rt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Mr = /-->/g, Lr = />/g,
    ye = RegExp(`>|${An}(?:([^\\s"'>=/]+)(${An}*=${An}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), zr = /'/g, Ur = /"/g, vo = /^(?:script|style|textarea|title)$/i,
    po = (e) => (t, ...n) => ({_$litType$: e, strings: t, values: n}), Ue = po(1), Ou = po(2),
    pe = Symbol.for("lit-noChange"), O = Symbol.for("lit-nothing"), Br = /* @__PURE__ */ new WeakMap(),
    Ae = De.createTreeWalker(De, 129);
function go(e, t) {
...
class Qe {
    ...
    $(t) {
        const {values: n, _$litType$: r} = t,
            i = typeof r == "number" ? this._$AC(t) : (r.el === void 0 && (r.el = Et.createElement(go(r.h, r.h[0]), this.options)), r);
...
const ni = (e) => {
    ...
    }, tu = (e) => (e.key === "Backspace" || e.key === "Delete") && !e.shiftKey && !e.ctrlKey && !e.altKey && !e.metaKey,
    ne = Zc(), Rt = "⇧", Mu = {
