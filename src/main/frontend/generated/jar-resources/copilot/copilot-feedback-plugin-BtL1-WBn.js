...
const h = "https://github.com/vaadin/copilot/issues/new", T = "?template=feature_request.md&title=%5BFEATURE%5D",
...
let a = class extends w {
    ...
    openGithub(e, t) {
        ...
        const n = e.replace(/\n/g, "%0A"), s = `${t.items.find((r) => r.value === this.type)?.ghTitle}`,
            i = t.description !== "" ? t.description : F,
            l = D.replace("{description}", i).replace("{versionsInfo}", n);
